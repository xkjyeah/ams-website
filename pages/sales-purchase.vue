            ...
            <tbody>
              <tr>
                ...
                <td
                  ...
                  style="text-align:center;"
                >
                  <strong>Pressure when full<br>(In Atm)</strong>
                </td>
                <td
                  rowspan="2"
                  style="text-align:center;"
                >
                  <strong>Volume of Gaseous O2 <br>(in Litres)</strong>
                </td>
                <td
                  colspan="3"
                  style="text-align:center;"
                >
                  <strong><i>Approximate</i> Duration based on Flow <br>(Litres/minute)</strong>
                </td>
              </tr>
              <tr>
